package bookmanagementFrame;
	...
	public class UserUpdate extends JFrame{
		...
		public UserUpdate(){
			...
			title = new JLabel("修改信息",SwingConstants.CENTER);//居中
...
//					System.out.println(userPassword1);
					...
					// TODO Auto-generated method stub
						...
						//将两次密码和 用户名 作为参数传入PutinStorage中的 userUpadate函数
						new bookmanagementStorage.PutinStorage().userUpdate(userPassword1,userPassword2,text);
						//账号注册成功后，弹出登陆界面
